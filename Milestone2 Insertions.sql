...
INSERT INTO Users (f_name,l_name,password,email,room,type,birthdate) VALUES 
('Magda','Sleem','12E_rT=JK','sleemmag124@gmail.com',3,'Admin','07-14-2001')
, ('Noha','Fawzy','Um/nnud189','nfawzy1992@gmail.com',7,'Admin','09-08-1992')
, ('Sleem','Shafeey','reT09=im23','shafeey.sleem192@gmail.com',2,'Admin','01-30-1986')
, ('Rasha','Adham','te4Un77-Fx','r_adham12@gmail.com',5,'Admin','04-17-2001')
, ('Mahmoud','Ezzat','1iop._23Rt','mahmodezt22@gmail.com',2,'Admin','02-08-1992');
...
INSERT INTO Users (f_name,l_name,password,email,room,type,birthdate) VALUES 
('Salma','Ayman','oPP0~gm22','salma_ayaman15@gmail.com',3,'Guest','11-24-1998')
, ('Magdy','Elsayed','mUb)dd_21','magdymls@gmail.com',7,'Guest','04-08-2000')
, ('Marwa','Roshdy','reT*g/im23','m.roshdii124@gmail.com',2,'Guest','01-19-1995')
, ('Ahmed','Fathy','tg8&dl_x','afathy2000@gmail.com',5,'Guest','07-12-2000')
, ('Ashraf','ElMeligy','3_rttY&i*_P','ashrafmeligy97@gmail.com',2,'Guest','02-08-1997');
...
INSERT INTO Device VALUES (1151,7,'microwave','off','no battery',NULL);
INSERT INTO Device VALUES (9274,7,'fridge','on','AC',NULL);
INSERT INTO Device VALUES (1156,2,'Emergency Light','off','charging',35);
INSERT INTO Device VALUES (2427,3,'Television','on','AC',NULL);
INSERT INTO Device VALUES (6129,6,'Virtual Assistant','off','full',99);
